  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h3>Category
          <a href="{{route('categories.create')}}" class="btn btn-primary btn-sm text-white float-end">Add Category</a>
        </h3>
        ...
        <table id="recent-purchases-listing" class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{route('categories.edit',$value->id)}}" class="btn btn-success p-2"><i class="mdi mdi-grease-pencil"></i></a>
